...
open class RemoteDataSource {
    ...
    private fun error(cause: HttpResult, code: Int?, errorMessage: String?): Results.Error {
        return Results.Error(cause, code, errorMessage)
    }

    private fun parseHttpError(throwable: HttpException): Results<Nothing> {
        return try {
